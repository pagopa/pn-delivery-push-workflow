...
class LegalFactGeneratorTemplatesTest extends CommonTestConfiguration {
    ...
    void testBuildAarSenderLogo() {
        ...
        PnDeliveryPushWorkflowConfigs mockPnDeliveryPushConfigs = Mockito.mock(PnDeliveryPushWorkflowConfigs.class);
        PnDeliveryPushWorkflowConfigs.Webapp mockWebapp = Mockito.mock(PnDeliveryPushWorkflowConfigs.Webapp.class);
        ...
        ReflectionTestUtils.setField(legalFactGeneratorTemplatesTest, "pnDeliveryPushWorkflowConfigs", mockPnDeliveryPushConfigs);
