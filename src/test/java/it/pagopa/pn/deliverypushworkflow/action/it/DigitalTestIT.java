...
class DigitalTestIT extends CommonTestConfiguration {
    ...
    void completeFailWithRegisteredLetterAlreadyViewedCourtesyEmail() {
       ...
       - Simulata visualizzazione notifica in fase di SEND_COURTESY_MESSAGE (Ottenuto valorizzando il tax id con TimelineClientMock.SIMULATE_VIEW_NOTIFICATION)
        */
        ...
        String taxId = TimelineClientMock.SIMULATE_VIEW_NOTIFICATION +  TimelineEventId.SEND_COURTESY_MESSAGE.buildEventId(EventId.builder()
                .iun(iun)
                .recIndex(0)
    ...
    void completeFailWithRegisteredLetterAlreadyViewedCourtesyAppIo(){
        ...
        */
        ...
        //Simulazione visualizzazione notifica a valle del send del messaggio di cortesi
        String taxId = TimelineClientMock.SIMULATE_VIEW_NOTIFICATION +  TimelineEventId.SEND_COURTESY_MESSAGE.buildEventId(
                EventId.builder()
                .iun(iun)
                .recIndex(0)
    ...
    private int checkAllAttemptsFails(LegalDigitalAddressInt platformAddress, LegalDigitalAddressInt digitalDomicile, LegalDigitalAddressInt pbDigitalAddress, String iun, Integer recIndex) {
        ...
        TestUtils.checkExternalChannelPecSend(iun, platformAddress.getAddress(), notificationIntsEvents.get(sentPecAttemptNumber).getIun(), digitalAddressesEvents.getFirst().getAddress());
  ...
  /*
    ...
    */
        ...
        TestUtils.checkExternalChannelPecSend(iun, pbDigitalAddress.getAddress(), notificationIntsEvents.getFirst().getIun(), digitalAddressesEvents.getFirst().getAddress());
  ...
  /*
    ...
    */
        ...
        TestUtils.checkExternalChannelPecSend(iun, digitalDomicile.getAddress(), notificationIntsEvents.getFirst().getIun(), digitalAddressesEvents.getFirst().getAddress());
