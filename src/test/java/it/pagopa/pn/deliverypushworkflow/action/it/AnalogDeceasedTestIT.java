...
public class AnalogDeceasedTestIT extends CommonTestConfiguration {
  ...
  /*
    ...
    */
        ...
        // Tramite l'utilizzo della costante TimelineClientMock.SIMULATE_VIEW_NOTIFICATION ci assicuriamo che la notifica
        // venga visualizzata in teoria anche prima dell'arrivo dell'evento di deceduto per il secondo recipient
        String taxIdRecipient2 = TimelineClientMock.SIMULATE_VIEW_NOTIFICATION +
