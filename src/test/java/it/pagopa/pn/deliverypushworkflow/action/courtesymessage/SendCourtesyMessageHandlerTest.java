...
class SendCourtesyMessageHandlerTest {
    ...
    void handleSendCourtesyMessageActionAppIoSuccess() {
        ...
        //WHEN
        sendCourtesyMessageHandler.handleSendCourtesyMessageAction(notification.getIun(), 0, details(CourtesyDigitalAddressInt.COURTESY_DIGITAL_ADDRESS_TYPE_INT.APPIO, DeliveryModeInt.ANALOG));
    ...
    void handleSendCourtesyMessageActionAppIoRetryableErrorIntervalsExhaustedClosesChannel() {
        ...
        sendCourtesyMessageHandler.handleSendCourtesyMessageAction(notification.getIun(), 0, details(CourtesyDigitalAddressInt.COURTESY_DIGITAL_ADDRESS_TYPE_INT.APPIO, DeliveryModeInt.ANALOG, 4));
    ...
    void handleSendCourtesyMessageActionTppRetryableErrorReschedulesWithBackoff() {
        ...
        Instant beforeCall = Instant.now();
        sendCourtesyMessageHandler.handleSendCourtesyMessageAction(notification.getIun(), 0, details(CourtesyDigitalAddressInt.COURTESY_DIGITAL_ADDRESS_TYPE_INT.TPP, DeliveryModeInt.ANALOG, 1));
        Instant afterCall = Instant.now();
    ...
    void handleSendCourtesyMessageActionEmailSuccess() {
        ...
        //WHEN
        sendCourtesyMessageHandler.handleSendCourtesyMessageAction(notification.getIun(), 0, details(CourtesyDigitalAddressInt.COURTESY_DIGITAL_ADDRESS_TYPE_INT.EMAIL, DeliveryModeInt.DIGITAL));
