...
import it.pagopa.pn.deliverypushworkflow.config.msclient.ActionManagerApiConfigurator;
import it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.actionmanager.api.ActionApi;
import it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.actionmanager.model.ActionTypeDto;
...
import static it.pagopa.pn.deliverypushworkflow.exceptions.PnDeliveryPushExceptionCodes.ERROR_CODE_DELIVERYPUSH_ACTION_CONFLICT;
import static it.pagopa.pn.deliverypushworkflow.exceptions.PnDeliveryPushExceptionCodes.ERROR_CODE_DELIVERYPUSH_FUTURE_ACTION_NOTFOUND;
...
class ActionManagerClientImplTest extends MockAWSObjectsTest {
    ...
    void testAddOnlyActionIfAbsentSuccess() throws JsonProcessingException {
        try (ClientAndServer ignored = startClientAndServer(9999);
             MockServerClient mockServerClient = new MockServerClient("localhost", 9999)) {
            NewActionDto actionRequest = new NewActionDto();
            ...
            actionRequest.setType(ActionTypeDto.valueOf(ActionTypeDto.ANALOG_WORKFLOW.name()));
