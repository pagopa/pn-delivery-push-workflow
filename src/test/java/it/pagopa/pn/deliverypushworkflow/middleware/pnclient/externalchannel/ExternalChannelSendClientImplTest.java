...
import it.pagopa.pn.deliverypushworkflow.dto.delivery.notification.NotificationSenderInt;
...
import it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.externalchannel.api.PaperMessagesApi;
...
class ExternalChannelSendClientImplTest {
    ...
    @BeforeEach
    void setup() {
        this.cfg = mock(PnDeliveryPushWorkflowConfigs.class);
                ...
                .documents(Arrays.asList(
                                NotificationDocumentInt.builder()
                                        ...
                                        .digests(NotificationDocumentInt.Digests.builder()
                                                .sha256((Base64.getEncoder().encodeToString("sha256_doc01".getBytes()))) //Todo: cambiato bas64
                                                .build()
                                        )
                                        .build()
                        )
