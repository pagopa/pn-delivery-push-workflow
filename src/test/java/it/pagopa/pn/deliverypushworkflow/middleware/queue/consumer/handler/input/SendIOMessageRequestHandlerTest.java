package it.pagopa.pn.deliverypushworkflow.middleware.queue.consumer.handler.input;

import it.pagopa.pn.api.dto.events.PnExtRegistryIOSentMessageEvent;
import it.pagopa.pn.deliverypushworkflow.action.iosentmessage.IOSentMessageHandler;
