...
import it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.templatesengine.api.TemplateApi;
...
public class TemplatesClientImpl implements TemplatesClient {
     ...
     */
    @Override
    public byte[] notificationReceivedLegalFact(LanguageEnumDto xLanguage, NotificationReceivedLegalFactDto legalFact) {
     ...
     */
    @Override
    public byte[] notificationViewedLegalFact(LanguageEnumDto xLanguage, NotificationViewedLegalFactDto notificationViewedLegalFact) {
     ...
     */
    @Override
    public byte[] pecDeliveryWorkflowLegalFact(LanguageEnumDto xLanguage, PecDeliveryWorkflowLegalFactDto pecDeliveryWorkflowLegalFact) {
     ...
     */
    @Override
    public byte[] analogDeliveryWorkflowFailureLegalFact(LanguageEnumDto xLanguage, AnalogDeliveryWorkflowFailureLegalFactDto analogDeliveryWorkflowFailureLegalFact) {
     ...
     */
    @Override
    public byte[] notificationCancelledLegalFact(LanguageEnumDto xLanguage, NotificationCancelledLegalFactDto notificationCancelledLegalFact) {
     ...
     */
    @Override
    public String notificationAarForSubject(LanguageEnumDto xLanguage, NotificationAarForSubjectDto notificationAarForSubject) {
     ...
     */
    @Override
    public byte[] notificationAar(LanguageEnumDto xLanguage, NotificationAarDto notificationAar) {
     ...
     */
    @Override
    public String notificationAarForSms(LanguageEnumDto xLanguage, NotificationAarForSmsDto notificationAarForSms) {
     ...
     */
    @Override
    public String notificationAarForEmail(LanguageEnumDto xLanguage, NotificationAarForEmailDto notificationAarForEmail) {
     ...
     */
    @Override
    public String notificationAarForPec(LanguageEnumDto xLanguage, NotificationAarForPecDto notificationAarForPec) {
     ...
     */
    @Override
    public byte[] notificationAarRaddAlt(LanguageEnumDto xLanguage, NotificationAarRaddAltDto notificationAarRaddAlt) {
