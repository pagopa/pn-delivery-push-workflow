...
public class TimelineClientImpl implements TimelineClient {
    ...
    @Override
    public boolean addTimelineElement(NewTimelineElementDto newTimelineElement) {
    ...
    @Override
    public TimelineElementDto getTimelineElement(String iun, String timelineId, Boolean strongly) {
    ...
    @Override
    public TimelineElementDetailsDto getTimelineElementDetails(String iun, String timelineId) {
    ...
    @Override
    public TimelineElementDetailsDto getTimelineElementDetailForSpecificRecipient(String iun, Integer recIndex, Boolean confidentialInfoRequired, TimelineCategoryDto category) {
    ...
    @Override
    public TimelineElementDto getTimelineElementForSpecificRecipient(String iun, Integer recIndex, TimelineCategoryDto category) {
    ...
    @Override
    public List<TimelineElementDto> getTimeline(String iun, Boolean confidentialInfoRequired, Boolean strongly, String timelineId) {
    ...
    @Override
    public NotificationHistoryResponseDto getTimelineAndStatusHistory(String iun, Integer numberOfRecipients, Instant createdAt) {
