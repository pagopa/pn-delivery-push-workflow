...
import it.pagopa.pn.deliverypushworkflow.dto.ext.externalchannel.DigitalMessageReferenceInt;
import it.pagopa.pn.deliverypushworkflow.dto.ext.externalchannel.EventCodeInt;
import it.pagopa.pn.deliverypushworkflow.dto.ext.externalchannel.ExtChannelDigitalSentResponseInt;
import it.pagopa.pn.deliverypushworkflow.dto.ext.externalchannel.ResponseStatusInt;
import it.pagopa.pn.deliverypushworkflow.dto.timeline.TimelineElementInternal;
import it.pagopa.pn.deliverypushworkflow.dto.timeline.details.DigitalSendTimelineElementDetails;
import it.pagopa.pn.deliverypushworkflow.dto.timeline.details.SendDigitalProgressDetailsInt;
...
import static it.pagopa.pn.deliverypushworkflow.exceptions.PnDeliveryPushExceptionCodes.ERROR_CODE_DELIVERYPUSH_SENDDIGITALTIMELINEEVENTNOTFOUND;
...
public class DigitalWorkFlowExternalChannelResponseHandler { 
    ...
    private ResponseStatusInt mapDigitalStatusInResponseStatus(EventCodeInt eventCode)
    {
        ...
        */
        ...
        PnDeliveryPushWorkflowConfigs.ExternalChannel externalChannelConfig = this.pnDeliveryPushConfigs.getExternalChannel();
