...
import it.pagopa.pn.deliverypushworkflow.service.mapper.NotificationPaidMapper;
...
public class NotificationPaidHandler {
    ...
    public String buildTimelineEventIdForPayment(NotificationPaidInt notificationPaidInt) {
