...
import static it.pagopa.pn.deliverypushworkflow.service.mapper.PaymentMapper.getNotificationPaymentInfo;
import static it.pagopa.pn.deliverypushworkflow.service.mapper.PaymentMapper.getNotificationPaymentItem;
...
public class RecipientMapper {
    ...
    public static NotificationRecipientInt externalToInternal(NotificationRecipientV24 recipient) {
        ...
        it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.delivery.model.NotificationDigitalAddress digitalDomicile = recipient.getDigitalDomicile();
