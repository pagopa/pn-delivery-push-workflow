...
public class NotificationMapper {
    ...
    public static SentNotificationV25 internalToExternal(NotificationInt notification) {
        ...
        if(notification.getNotificationFeePolicy() != null){
            sentNotification.setNotificationFeePolicy(it.pagopa.pn.deliverypushworkflow.generated.openapi.msclient.delivery.model.NotificationFeePolicy.fromValue(notification.getNotificationFeePolicy().getValue()));
        }
