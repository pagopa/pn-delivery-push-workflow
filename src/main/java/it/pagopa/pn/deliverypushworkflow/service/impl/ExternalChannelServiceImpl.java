...
import static it.pagopa.pn.deliverypushworkflow.dto.ext.datavault.RecipientTypeInt.PF;
...
public class ExternalChannelServiceImpl implements ExternalChannelService {
    ...
    private void addInformationToAddress(String iun, int recIndex, LegalDigitalAddressInt legalDigitalAddressInt) {
        ...
        if (timeline.isPresent()) {
            ...
            String SERCQ_AAR_TIMESTAMP_INIT = "?timestamp=";
            if (!legalDigitalAddressInt.getAddress().contains(SERCQ_AAR_TIMESTAMP_INIT)) {
                legalDigitalAddressInt.setAddress(address + SERCQ_AAR_TIMESTAMP_INIT + timestamp);
            }
