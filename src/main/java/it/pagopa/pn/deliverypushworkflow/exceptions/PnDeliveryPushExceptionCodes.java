...
public class PnDeliveryPushExceptionCodes extends PnExceptionsCodes {
    ...
    public static final String ERROR_CODE_DELIVERYPUSH_DATAVAULTMANDATESERROR = "PN_DELIVERYPUSH_DATAVAULTMANDATESERROR";
    public static final String ERROR_CODE_DELIVERYPUSH_DATAVAULTMANDATES_NOT_FOUND = "PN_DELIVERYPUSH_DATAVAULTMANDATES_NOT_FOUND";
    public static final String ERROR_CODE_DELIVERYPUSH_DATAVAULTADDRESSERROR = "PN_DELIVERYPUSH_DATAVAULTADDRESSERROR";
